/**
 * Sky State Adapter — Bridge between Firestore positions and Rules Engine
 *
 * Reads pre-fetched positions from `global_astro/sky_positions` (maintained
 * by functions/sky_positions.js) and transforms them into the format our
 * Brihat Samhita rules engine expects.
 *
 * Also enriches positions with nakshatra data using lib/vedic_utils.js
 * and computes Sun-planet distances for combustion detection.
 *
 * REUSES: sky_positions.js data, vedic_utils.js, aspect_calculator.js
 */
