...
class AddedToGramTile extends StatefulWidget {
  final Map? data;

  const AddedToGramTile({this.data, Key? key}) : super(key: key);

  @override
  _AddedToGramTileState createState() => _AddedToGramTileState();
}
