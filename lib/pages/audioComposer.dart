...
class AudioComposerState extends State<AudioComposer>
  ...
  final FlutterSoundRecorder _recorder =
      FlutterSoundRecorder(logLevel: kDebugMode ? Level.debug : Level.nothing);
  final FlutterSoundPlayer _player =
      FlutterSoundPlayer(logLevel: kDebugMode ? Level.debug : Level.nothing);
        ...
        children: List.generate(_waveformBars.length, (index) {
          return AnimatedContainer(
            ...
            decoration: BoxDecoration(
              ...
              color: isActive
                  ? primaryColor.withOpacity(0.4 + _waveformBars[index] * 0.6)
