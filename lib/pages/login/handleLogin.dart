...
import 'package:aurogram/pages/login/initUser.dart';
import 'package:aurogram/pages/login/login.dart';
import 'package:aurogram/pages/spaces/inviteLandingPage.dart';
...
class HandleLogin extends StatefulWidget {
  ...
  const HandleLogin({Key? key, this.space, this.invitee}) : super(key: key);
  @override
