...
/// Skeleton loading grid shown during initial gram list load.
class GramsSkeletonGrid extends StatelessWidget {
  const GramsSkeletonGrid({super.key});
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          ...List.generate(5, (index) => GramsSkeletonItem(index: index)),
...
/// Single skeleton item matching GramPreviewBox layout with shimmer animation.
class GramsSkeletonItem extends StatelessWidget {
  final int index;

  const GramsSkeletonItem({super.key, this.index = 0});
