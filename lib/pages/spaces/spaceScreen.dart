...
import 'package:aurogram/pages/spaces/editSpace.dart';
import 'package:aurogram/pages/spaces/gridSpaceView.dart';
...
class SpaceScreen extends StatefulWidget {
  ...
  const SpaceScreen({Key? key, required this.rid, this.postId})
      : super(key: key);
