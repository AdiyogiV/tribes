...
import 'package:aurogram/pages/spaces/addSpacesMembers.dart';
...
class EditSpace extends StatefulWidget {
  final String? space;
  const EditSpace({Key? key, this.space}) : super(key: key);
...
class EditSpaceState extends State<EditSpace>
  ...
  Future<void> onSavePressed() async {
    ...
    space!.displayPicture = _imageFilePath;
    ...
    final spaceDbService = locator<SpaceDbService>();
    await spaceDbService.updateSpace(space!);
    if (mounted) {
