import 'package:aurogram/core/startup/startup_auth.dart';
import 'package:aurogram/core/startup/startup_config.dart';
import 'package:aurogram/core/startup/startup_services.dart';

// Re-export the top-level background notification handler so existing
// references to the old file still compile.
export 'package:aurogram/core/startup/startup_services.dart'
