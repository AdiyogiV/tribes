...
export 'package:aurogram/models/chat_message.dart';
export 'package:aurogram/models/dm_conversation.dart';
...
// Mixin imports
import 'package:aurogram/services/chat/chat_message_operations.dart';
import 'package:aurogram/services/chat/chat_stream_handlers.dart';
import 'package:aurogram/services/chat/chat_presence.dart';
import 'package:aurogram/services/chat/chat_conversation_settings.dart';

// Re-export mixin files so existing imports continue to work
export 'package:aurogram/services/chat/chat_message_operations.dart';
export 'package:aurogram/services/chat/chat_stream_handlers.dart';
export 'package:aurogram/services/chat/chat_presence.dart';
export 'package:aurogram/services/chat/chat_conversation_settings.dart';
