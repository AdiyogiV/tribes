...
/// A soft, rounded marketing card — warmer than the stark editorial dashboard
/// cards. Single source of chrome for the whole guest page.
class GuestCard extends StatelessWidget {
  ...
  /// Optional accent used for a faint corner wash.
  final Color? tint;
