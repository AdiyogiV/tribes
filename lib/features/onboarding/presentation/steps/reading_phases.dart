...
// Reading Phase
//
// The single detailed onboarding reading (identity + trajectory + present
// chapter). Replaces the former BirthReadingPhase + CurrentTimesReadingPhase,
// which were near-identical and are now folded into one reading.
// ============================================================================
class ReadingPhase extends StatelessWidget {
  ...
  bool get _hasReading => readingContent != null && readingContent!.isNotEmpty;
    ...
    if (isGenerating && !_hasReading) {
      return Column(
        children: [
          ...
          Text(
            'Writing your personalized reading...',
            style: TextStyle(
