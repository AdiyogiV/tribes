...
old_calls = """_buildDataRow(context, 'V A T A', 'The Energy of Movement', 'Air & Space · Governs the nervous system', 'Governs breathing, blinking, muscle movement, heartbeat, and all cellular mobility.', prakriti.vata, vikriti!.vata, fgMain, fgMuted, fgFaint, lineCol, _getDoshaColor('vata')),
...
new_calls = """_buildDataRow(context, 'Vata', 'AIR & SPACE · MOVEMENT', 'Governs breathing, blinking, muscle movement, heartbeat, and all cellular mobility.', prakriti.vata, vikriti!.vata, fgMain, fgMuted, fgFaint, lineCol, _getDoshaColor('vata')),
...
# 2. Update _buildDataRow signature and the entire left column
old_row_start = """  Widget _buildDataRow(BuildContext context, String label, String editorialSub, String smallLine, String desc, int base, int cur, Color fgMain, Color fgMuted, Color fgFaint, Color lineCol, Color rowColor) {
...
new_row_start = """  Widget _buildDataRow(BuildContext context, String label, String subline, String desc, int base, int cur, Color fgMain, Color fgMuted, Color fgFaint, Color lineCol, Color rowColor) {
    final shift = cur - base;
    final shiftStr = shift > 0 ? '+$shift%' : (shift < 0 ? '$shift%' : '—');
    final shiftColor = shift > 0 ? rowColor : fgMuted;
