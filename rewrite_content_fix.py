...
new_chic_content = """Widget _buildChicContent(BuildContext context, Color fgMain, Color fgMuted, Color fgFaint, Color lineCol, Color bg) {
    ...
    final String vikritiType = hasVikriti ? (vikriti!.type ?? 'Balancing') : "Balancing";

    final foodTips = hasVikriti ? _getFoodTips(vikriti!.type) : _getFoodTips(prakriti.type);
    final doTips = hasVikriti ? _getDoTips(vikriti!.type) : _getDoTips(prakriti.type);
