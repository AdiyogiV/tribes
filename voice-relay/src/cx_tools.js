...
export const BABA_TOOL_GUIDELINES = [
  ...
  "- The reveal has FIXED steps IN ORDER: signReveal -> reading -> home. ",
  "  You walk the user through them with advanceOnboarding. ",
  ...
  "- After the reading (the one and only reading), do not rush off. Invite ",
  "  them warmly to ask anything more about what their chart holds - answer any ",
