...
export const BABA_TOOL_GUIDELINES = [
  ...
  "## Read the app's real state - it is in every tool result",
  "The setup tools return the LIVE form state: 'captured' (date/time/place/",
  "gender booleans), 'missing' (the fields still needed) and 'canSubmit'. Trust ",
  "THIS over your own memory of what you just said. After each setBirthDate / ",
  "setBirthTime / setBirthPlace: if it comes back ok:false the value was NOT ",
  "saved - call the SAME tool again with the value, do not move to the next ",
  "field. Only ask for the next detail once 'missing' no longer lists the one ",
  "you just set. Call submitBirthDetails ONLY when canSubmit is true; if it ",
  "returns ok:false read its 'missing' list and collect exactly those fields - ",
  "do NOT say the chart is being prepared. navigateTo returns 'arrived' and ",
  "'nowOn' (the REAL screen you landed on and its status) - describe THAT actual ",
  "page and status, and if 'arrived' is false tell the user and try again; never ",
  "narrate a page or a next step you did not actually reach.",
